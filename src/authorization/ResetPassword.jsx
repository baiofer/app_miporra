...
import './Login.css'
import { removeAuthorizationHeader, setAuthorizationHeader } from "../api/config/client"
    ...
    return(
        <div>
            ...
            <div style={{ marginBottom: '10px' }}>
                <Button variant="primary-cta" onClick={handleOnClick}>Cambia tu contraseña</Button>
            </div>
            { message && 
                <div>
                    <div 
